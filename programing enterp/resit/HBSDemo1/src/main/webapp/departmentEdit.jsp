...
<div class="container mt-5 d-flex justify-content ">
  <div class="container">
   <h3 class="text-center">Edit Departments</h3>
   <hr>
   <div class="container text-left">
   
   <div class="text-right">
                <a class="btn btn-primary" href="department?action=list">List All Departments</a>
                </div>
   
<div class="container col-md-8 col-md-offset-3" style="overflow: auto">
<h5 style="color: red;">${error}</h5>
            <form action="department?action=update" method="post">

                <div class="form-group">
                <input type="hidden" id="id" name="id" value="${id}">
                    <label for="name">Department Name:</label> <input type="text" class="form-control" id="name" placeholder="Department Name" name="name" value="${name}" required>
                </div>
